package hbs.booking.security;

import hbs.booking.enums.AccountRole;
import hbs.booking.repository.TokenRepository;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .hasAnyRole(AccountRole.CUSTOMER.name(), AccountRole.MANAGER.name(), AccountRole.ADMIN.name())
                        .requestMatchers("/api/v*/manager/**")
                        .hasRole(AccountRole.MANAGER.name())
                        .requestMatchers("api/v*/admin/**")
                        .hasAnyRole(AccountRole.ADMIN.name(), AccountRole.SUPER_ADMIN.name())
                        .requestMatchers(AuthWL).permitAll()
    ...
    private static final String[] AuthWL = {
        "/api/v1/auth/**",
            "/v3/api-docs/**",
            "/v3/api-docs.yaml",
            "/swagger-ui/**",
