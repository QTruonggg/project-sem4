...
import hbs.booking.model.dto.response.booking.customer.FeedbackHouseholdDto;
import hbs.booking.model.dto.response.dashboard.manager.LowFeedbackDetailForManager;
...
public interface FeedbackRepository extends BaseRepository<Feedback, Long>{
    ...
    @Query("SELECT new hbs.booking.model.dto.response.feedback.EditFeedbackForm(" +
    ...
    @Query("SELECT distinct new hbs.booking.model.dto.response.feedback.FeedbackForManagerResponse(" +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.feedback.FeedbackForManagerResponse(" +
            "fb.id, b.bookingCode,b.totalRoom, b.totalGuest,b.checkInDate, b.checkOutDate, b.createdDate, " +
            "b.totalPrice, fb.content, fb.rating, fb.status, c.firstName, c.lastName, ca.email) " +
            "FROM Feedback fb join fb.customer c join c.account ca join fb.booking b " +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.booking.customer.FeedbackHouseholdDto(" +
    ...
    @Query("select new hbs.booking.model.dto.response.dashboard.manager.LowFeedbackDetailForManager(" +
