...
import hbs.booking.model.dto.response.dashboard.admin.RequestDetailForAdmin;
...
public interface RequestRepository extends BaseRepository<Request, Long> {
    @Query("SELECT new hbs.booking.model.dto.response.request.RequestResponseDto(r.id, h.householdName, h.avatar, r.createdDate, r.requestTitle, r.requestContent, r.solvedDate, '', '', r.requestStatus) " +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.request.RequestResponseDto(r.id, h.householdName, h.avatar, r.createdDate, r.requestTitle, r.requestContent, r.solvedDate, a.firstName, a.lastName, r.requestStatus) " +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.request.RequestForManagerDto(r.id, r.createdDate, r.requestTitle, r.requestContent, r.solvedDate, r.requestResponse, r.requestStatus) " +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.request.RequestDetailResponseDto(h.householdName, h.avatar, m.firstName, m.lastName, m.phoneNumber, ma.email, r.createdDate, r.requestTitle, r.requestContent, r.solvedDate, '', '', r.requestResponse, r.requestStatus) " +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.request.RequestDetailResponseDto(h.householdName, h.avatar, m.firstName, m.lastName, m.phoneNumber, ma.email, r.createdDate, r.requestTitle, r.requestContent, r.solvedDate, a.firstName, a.lastName, r.requestResponse, r.requestStatus) " +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.dashboard.admin.RequestDetailForAdmin(" +
