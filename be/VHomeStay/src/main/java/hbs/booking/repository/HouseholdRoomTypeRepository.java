...
import hbs.booking.model.dto.response.roomtype.customer.HouseholdRoomTypeForCustomerResponse;
...
public interface HouseholdRoomTypeRepository extends BaseRepository<HouseholdRoomType, Long> {
    ...
    @Query("select new hbs.booking.model.dto.response.RoomPriceUpdateDto(hrt.id, rt.roomTypeName, hrt.price, hrt.priceUpdate) " +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.roomtype.customer.HouseholdRoomTypeForCustomerResponse(" +
