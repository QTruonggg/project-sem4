...
import hbs.booking.model.dto.response.dashboard.manager.BookingCancelDetailForManager;
...
public interface BookingRepository extends BaseRepository<Booking, Long>{
    ...
    @Query("SELECT new hbs.booking.model.dto.response.feedback.AddFeedbackForm(" +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.user.BookingOfCustomerDto(" +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.dashboard.manager.BookingCancelDetailForManager(" +
