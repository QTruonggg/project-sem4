...
import hbs.booking.model.dto.response.localproduct.admin.LocalProductDetailForAdminResponse;
import hbs.booking.model.dto.response.localproduct.admin.LocalProductPositionDetail;
import hbs.booking.model.dto.response.localproduct.admin.LocalProductTop5DetailForAdmin;
...
public interface LocalProductRepository extends BaseRepository<LocalProduct, Long>{
    ...
    @Query("SELECT new hbs.booking.model.dto.response.localproduct.admin.LocalProductPositionDetail(" +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.localproduct.customer.LocalProductDetailForCustomerResponse(" +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.localproduct.admin.LocalProductDetailForAdminResponse(" +
    ...
    @Query("SELECT new hbs.booking.model.dto.response.localproduct.admin.LocalProductTop5DetailForAdmin(" +
