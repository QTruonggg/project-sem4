...
import hbs.booking.enums.MediaType;
...
import hbs.booking.repository.LocalProductRepository;
import hbs.booking.repository.VillageMediaRepository;
...
public class VillageMediaServiceImpl extends BaseServiceImpl<VillageMedia, Long, VillageMediaRepository>
    ...
    public List<String> getVillageMediaHomePage() {
        ...
        String imageHomeSub = images.get(0);
