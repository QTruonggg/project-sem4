...
import { SearchBookingContext } from '@/app/homestay-booking/search/page';
...
export default function SearchContent({
    ...
    const { setServices, setHaveDorm, setPriceRange } = React.useContext(SearchBookingContext);
    ...
    return (
        ...
        <div className='col-span-3'>
            <div className='mb-5 text-2xl font-medium'>Lọc kết quả</div>
                ...
                <div className='text-lg font-bold mb-5'>Giá</div>
                <Slider
                    range={{
                        draggableTrack: true,
                    }}
                    ...
                    marks={{
                        0: '0',
                        [maxPrice]: `${maxPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.')}`,
                    }}
