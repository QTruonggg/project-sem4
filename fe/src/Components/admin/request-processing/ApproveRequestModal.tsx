...
export interface IApproveRequestModalProps {
    requestId: number;
    onCancel: () => void;
    change: boolean;
            ...
            <div className="bg-white p-4 rounded-lg w-1/3 shadow-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className='flex flex-col'>
                        ...
                        <input type="hidden" {...register('requestStatus')} value={'APPROVED'} />
                        <input type="hidden" {...register('requestId')} value={requestId} />
                        <div className='flex my-5'>
                            <label htmlFor="requestResponse" className='w-24 font-semibold'>Phản hồi</label>
                            <textarea
                            maxLength={150}
                            rows={5}
                    ...
                    <div className="my-3 flex justify-end">
                        <button
                            className="px-4 py-2 mr-2 bg-green-500 text-white rounded-lg"
                            type="submit"
                        >
                            Chấp nhận
                        </button>
