...
import UpdateImageManager from '@/Components/profile/UpdateImageManager';
dayjs.locale('vi');
...
export default function EditProfile(props: IEditProfileProps) {
  ...
  React.useEffect(() => {
    ...
    fetchProfile();
  }, [isEditAvatar, setAuthState, setValue]);
      ...
      <div className='grid grid-cols-3 gap-5'>
        <div className='py-16 justify-center rounded-xl shadow-lg shadow-gray-300'>
          ...
          <div className='w-1/2 text-center m-auto'>
            <UpdateImageManager avatar={user?.avatar || ''} isEditAvatar={isEditAvatar} setIsEditAvatar={setIsEditAvatar} />
